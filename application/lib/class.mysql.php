...
class Database {
   ...
   public function connect() {
      ...
      if (!$this->link_id)
         $this->error('<div style="text-align:right; font-family: Arial; font-size: .8em;">'
                 . '<span style="padding: 15px; border: 3px solid #CCC; background-color:#FFF;">'
   ...
   private function error($msg = '') {
      ...
      $the_error = '<div style="background-color:#FAFAFA; font-family: Arial; border: 3px solid #CCC; padding:20px; width: 600px; border-radius:4px; font-size: .8em">';
      ...
      $the_error .= "<li> Script URI : " . $_SERVER['REQUEST_URI'] . "</li>";
      $the_error .= '</ul>';
      $the_error .= '</div>';
      if ($DEBUG)
         echo $the_error;
