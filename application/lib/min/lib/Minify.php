...
class Minify {
    ...
    protected static function _errorExit($header, $url)
    {
        ...
        echo "<p>Please see <a href='$url'>$url</a>.</p>";
            ...
            echo "<h1>Oppsss!</h1><h2>All I know there is nothing here like you have requested from ".CLO_SITE_NAME.".</h2>";
            echo "<p>Please be sure you typed the right url.<br>Return to ".CLO_SITE_NAME." <a href='".CLO_URL."'>Home Page</a>.</p>";            
        }
        exit();
    }
